                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="precio in arrayPrecios" :key="precio.id">
                                    ...
                                    <td>{{ FormatoMoneda(precio.costo) }}</td>
                                    <td>{{ FormatoPercentage(precio.porcentaje) }}</td>
                                    <td>{{ FormatoMoneda(precio.preciodeventa) }}</td>
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" :value="FormatoMoneda(costo)" @input="actualizarCosto($event.target.value)" class="form-control" placeholder="Costo producto">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" :value="FormatoPercentage(porcentaje)" @input="actualizarPorcentaje($event.target.value)" class="form-control" placeholder="Porcentaje">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <label for="precioventa">Precio de venta: {{ FormatoMoneda(precioVentaCalculado) }}</label>
...
export default {
    ...
    computed:{
        ...
        if (this.porcentaje <= 0 || this.porcentaje >= 100) return 0;
    ...
    FormatoPercentage(value) {
        return `${value}%`;
    },
    actualizarCosto(valor) {
    // Elimina cualquier caracter que no sea número
    let limpio = valor.replace(/[^0-9]/g, '');
    this.costo = parseInt(limpio) || 0;
},

actualizarPorcentaje(valor) {
    // Elimina todo excepto números
    let limpio = valor.replace(/[^0-9]/g, '');
    let num = parseInt(limpio) || 0;
    if (num > 100) num = 100; // Máximo 100%
    this.porcentaje = num;
    },
        listarPrecios(page){
            let me=this;
